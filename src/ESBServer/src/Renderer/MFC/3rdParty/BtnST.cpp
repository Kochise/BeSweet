...
void CButtonST::InitToolTip()
{
    ...
    //cider: ensure that the text is display always above the button
    //similar to http://support.microsoft.com/default.aspx?scid=http://support.microsoft.com:80/support/kb/articles/Q247/3/82.ASP&NoWebContent=1 
    m_ToolTip.SetWindowPos(&wndTopMost, 0,0,0,0, SWP_NOSIZE | SWP_NOMOVE);
	} // if
  m_ToolTip.SetWindowPos(&wndTopMost, 0,0,0,0, SWP_NOSIZE | SWP_NOMOVE | SWP_NOACTIVATE);
} // End of InitToolTip
